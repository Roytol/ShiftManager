    ...
    return (
        <div style={{
            ...
            <div className="card" style={{ width: '100%', maxWidth: '400px' }}>
                ...
                <h2 style={{ marginBottom: '1.5rem', textAlign: 'center', fontSize: '1.25rem', color: 'var(--text-secondary)' }}>{t('signup') || 'Sign Up'}</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="btn btn-primary" style={{ width: '100%' }} disabled={loading}>
                        {loading ? (t('signing_up') || 'Signing Up...') : (t('signup') || 'Sign Up')}
                    </button>
